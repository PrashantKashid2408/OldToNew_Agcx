...
namespace AdaniCall.Business.DataAccess.Constants
{
    ...
    public class KioskMasterStoredProcedures
    {
        ...
        public static string GetKioskMasterRecords = "KioskMaster_GetRecords"; // ADDED BY PRATIK 19/JAN/2022 
        ...
        public static string KioskMasterUpdateStatus = "KioskMaster_UpdateStatus"; //ADDED BY  PRATIK 19/JAN/2022
