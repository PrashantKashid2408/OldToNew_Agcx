...
{
    public class LocationSettingDescBusinessFacade//:UniversalObject
    {
        dynamic objdynamicWrapper; 
		LocationSettingDescWrapperColletion objLocationSettingDescWrapperColletion = new LocationSettingDescWrapperColletion();
        LocationSettingDescWrapper objLocationSettingDescWrapper = new LocationSettingDescWrapper();
		private static readonly string _module = "AdaniCall.Business.BusinessFacade.LocationSettingDescBusinessFacade";
		public LocationSettingDescBusinessFacade()
        {
            
        }
        public LocationSettingDescBusinessFacade(dynamic WrapperType)
        {
        ...
        public bool Save(dynamic objEntity)
        {
            try
            {
                ...
                objLocationSettingDescWrapper.objWrapperClass = objEntity;
                ...
                bool result = objLocationSettingDescWrapper.Save(ref CommandsObj, ref commandCounter);
        ...
        public bool updateSave(dynamic objEntity)
        {
            try
            {
