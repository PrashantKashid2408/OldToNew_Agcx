...
{
    public class IconMasterBusinessFacade//:UniversalObject
    {
        dynamic objdynamicWrapper; 
		IconMasterWrapperColletion objIconMasterWrapperColletion = new IconMasterWrapperColletion();
        IconMasterWrapper objIconMasterWrapper = new IconMasterWrapper();
		private static readonly string _module = "AdaniCall.Business.BusinessFacade.IconMasterBusinessFacade";
		public IconMasterBusinessFacade()
        {
            
        }
        public IconMasterBusinessFacade(dynamic WrapperType)
        {
