...
namespace AdaniCall.Entity
{
    public class Users
    {
        ...
        private string _airportShortName;
        private string _defaultName;
        private string _defaultPhone;
        ...
        {
            get { return this._airportShortName; }
            set { this._airportShortName = value; }
        }
        public string DefaultName
        {
            get { return this._defaultName; }
            set { this._defaultName = value; }
        }
        public string DefaultPhone
        {
            get { return this._defaultPhone; }
            set { this._defaultPhone = value; }
        }
        public string DefaultEmail
        {
            get { return this._defaultEmail; }
            set { this._defaultEmail = value; }
        }
        public string LevelTwoName
        {
            get { return this._levelTwoName; }
            set { this._levelTwoName = value; }
        }
